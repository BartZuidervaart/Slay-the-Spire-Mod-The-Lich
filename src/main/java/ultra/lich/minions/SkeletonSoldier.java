...
public class SkeletonSoldier extends AbstractControlableLichMinion{
    ...
    private Runnable attackAction = () -> {
        ...
        addToBot(new DamageAction(target, info, AbstractGameAction.AttackEffect.SLASH_DIAGONAL));
        this.didAction = true;
    };
    ...
    public SkeletonSoldier(AbstractCreature summoner, int hp, int attack, int defense) {
